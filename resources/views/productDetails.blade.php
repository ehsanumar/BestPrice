    ...
    <div class="bg-gray-200  py-8">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col md:flex-row -mx-4">
                ...
                <div class="md:flex-1 px-4">
                    <h2 class="text-2xl font-bold text-gray-800  dark:text-white mb-2">Name: {{ $productes->name }}</h2>
                            ...
                            <dialog id="my_modal_4" class="modal">
                                <div class="modal-box w-1/2 max-w-5xl">
                                    ...
                                    <form action="{{ route('comment.store') }}" method="post">
                                        ...
                                        <input type="number" name="product_id" required value="{{ $productes->id }}"
                                            hidden>
                                        ...
                                        <div class="chat chat-start">
                                            ...
                                            <div class="chat-bubble">{{ $comment->message }}
                                                ...
                                                <div class="flex justify-between items-center space-x-8">
                                                    @if (auth()->id() === $comment->pharmacy_id)
